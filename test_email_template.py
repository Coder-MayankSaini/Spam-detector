#!/usr/bin/env python3
"""
Test script for the new HTML email template
This script will generate a preview HTML file to see how the email looks
"""

def generate_email_preview():
    """Generate a preview HTML file of the password reset email"""
    
    # Sample data for preview
    reset_link = "http://localhost:3000/reset-password?token=sample_token_123"
...
"""
    ...
    print("📄 Open 'email_preview.html' in your browser to see how the email will look.")
    print("🎨 The email now features:")
    print("   - Beautiful gradient background")
    print("   - Professional header with logo")
    print("   - Prominent call-to-action button")
    print("   - Security information box")
    print("   - Alternative link section")
